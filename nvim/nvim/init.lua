...
-- Set cmdheight to 6 for debugging
...
vim.keymap.set('n', '<leader>fh', require('telescope.builtin').git_files, { desc = '[F]ind [G]it files' })
-- vim.keymap.set('n', '<leader>fh', require('telescope.builtin').help_tags, { desc = '[F]ind [H]elp' })

require('nvim-treesitter.configs').setup {
  ensure_installed = { 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'go' },
  auto_install = false,
